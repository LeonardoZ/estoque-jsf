...
public class Cnpj implements StringValueObject {
    ...
    public String cnpj() {
	return new StringBuilder().append(valor.substring(0, 3)).append(".").append(valor.substring(3, 6)).append(".")
		.append(valor.substring(6, 9)).append("/").append(valor.substring(9, 13)).append("-")
		.append(valor.substring(13)).toString();
    }
