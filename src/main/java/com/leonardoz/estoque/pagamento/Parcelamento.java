...
public class Parcelamento {
	...
	jurosVencimento = Juros.SEM_JUROS;
	taxa = Porcentagem.NENHUM;
	juros = Juros.SEM_JUROS;
	taxaDeJurosDeVencimento = Porcentagem.NENHUM;
    }
	...
	this.juros = juros == null ? Juros.SEM_JUROS : juros;
	this.taxa = taxa == null ? Porcentagem.NENHUM : taxa;
    }
